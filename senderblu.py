...
# script. It will send the content of "blu.TXT" file.
...
file_path = "/home/stefano/Scrivania/ProgettoBocci/testlogfiles/blu.TXT"
...
with open(file_path, 'r') as logfile:
    	 for line in logfile:
    	 	client.publish("daqardusipm/ARDU_BLU", line)
    	 	# print(line)
    	 	p_cont=i_cont*100/l
